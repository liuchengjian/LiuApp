...
//        mPictureParameterStyle.pictureOriginalTextSize = 14;
    ...
    public static PictureParameterStyle getCustomParameterStyle(Context context,boolean isChangeStatusBarFontColor,boolean isOpenCompletedNumStyle,boolean isOpenCheckNumStyle,String color) {
        ...
        PictureParameterStyle mPictureParameterStyle = new PictureParameterStyle();
        // 是否改变状态栏字体颜色(黑白切换)
        mPictureParameterStyle.isChangeStatusBarFontColor = isChangeStatusBarFontColor;
        // 是否开启右下角已完成(0/9)风格
        mPictureParameterStyle.isOpenCompletedNumStyle = isOpenCompletedNumStyle;
        // 是否开启类似QQ相册带数字选择风格
        mPictureParameterStyle.isOpenCheckNumStyle = isOpenCheckNumStyle;
        // 相册状态栏背景色
        mPictureParameterStyle.pictureStatusBarColor = Color.parseColor(color);
        // 相册列表标题栏背景色
        mPictureParameterStyle.pictureTitleBarBackgroundColor = Color.parseColor(color);
        // 相册列表标题栏右侧上拉箭头
        mPictureParameterStyle.pictureTitleUpResId = R.drawable.picture_icon_arrow_up;
        // 相册列表标题栏右侧下拉箭头
        mPictureParameterStyle.pictureTitleDownResId = R.drawable.picture_icon_arrow_down;
...
//        mPictureParameterStyle.pictureOriginalTextSize = 14;
    ...
    private static PictureParameterStyle getWhiteStyle(Context context) {
        ...
        // 标题栏字体颜色
        mPictureParameterStyle.pictureTitleTextColor = ContextCompat.getColor(context, R.color.app_color_black);
        // 相册右侧取消按钮字体颜色  废弃 改用.pictureRightDefaultTextColor和.pictureRightDefaultTextColor
...
//        mPictureParameterStyle.pictureWeChatPreviewSelectedTextSize = 9;
    ...
    public static PictureParameterStyle getNumStyle(Context context) {
        ...
        mPictureParameterStyle.pictureLeftBackIcon = R.drawable.picture_icon_back;
        // 标题栏字体颜色
        mPictureParameterStyle.pictureTitleTextColor = ContextCompat.getColor(context, R.color.app_color_white);
        // 相册右侧取消按钮字体颜色  废弃 改用.pictureRightDefaultTextColor和.pictureRightDefaultTextColor
...
//        mPictureParameterStyle.pictureOriginalTextSize = 14;
     ...
     * 动态自定义裁剪主题
     */
    public static PictureCropParameterStyle pictureCropParameterStyle(Context context, PictureParameterStyle mPictureParameterStyle) {
        // 裁剪主题
